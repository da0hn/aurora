...
import aurora.core.analyzer.utils.PredicateService;
...
import static aurora.core.analyzer.lexical.Lexical.Controls.incrementLine;
import static aurora.core.analyzer.lexical.Lexical.Controls.resetColumn;
import static aurora.core.analyzer.lexical.Lexical.Controls.setLineLength;
import static aurora.core.analyzer.lexical.interfaces.LexicalService.stringAnalyzer;
...
//            System.out.println(parsedLines + " size -> " + parsedLines.size());
    ...
    private void analyzeLines(List<TokenContainer> tokens, List<String> lines) {
        ...
        while(it.hasNext()) {
            ...
            if(current.equals("\"")) {
                if(stringAnalyzer(tokens, it)) return;
                continue;
            }
