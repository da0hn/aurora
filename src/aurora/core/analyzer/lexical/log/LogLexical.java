package aurora.core.analyzer.lexical.log;

import aurora.core.analyzer.lexical.exception.LexicalException;
import aurora.core.analyzer.lexical.interfaces.LexicalObject;
import aurora.core.analyzer.lexical.utils.ErrorMessage;
...
import static aurora.util.parser.Flag.READABLE;
import static aurora.util.parser.Flag.TOKENS;
